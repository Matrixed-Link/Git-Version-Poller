        ...
        if (tags[repoName] == undefined) {
            ...
            if (original_old_tag != original_tag) {
                ...
                for (x in old_tag.split('.')) {
                    extractedTags.old.push(Number(old_tag.split('.')[x]))
                    extractedTags.new.push(Number(tag.split('.')[x]))
                }
                for (x in extractedTags.old) {
                    console.log('new', extractedTags.new[x], 'old', extractedTags.old[x])
                    if (extractedTags.new[x] > extractedTags.old[x]) {
                        ...
                        break
                    } else if (extractedTags.new[x] < extractedTags.old[x]) {
